/*
JS é uma linguagem de tipagem dinâmica, ou seja, uma variavel pode receber qualquer valor que isso será inferido automaticamente,
e essa mesma variavel pode tá armazenando um array, string, depois um number.

zero based - contagem começa pelo zero
*/  


/*
Durante a resolução desta bateria de exercícios você verá erros no console do navegador. 
...
Conserte a "declaração" da variável abaixo. 
 - quando uma variavel é declarada sem LET ou CONST, por debaixo dos panos ela vira VAR, então VAR, gera variavel global.
 Desde 2015 nasceu: LET e CONST 
*/
...
const sigla = curso[0] + curso[9] + curso[20] + curso[26] //mais legivel nesse caso especifico
const palavra = `${curso[0]}${curso[9]}${curso[20]}${curso[26]}`
console.log(sigla)
console.log(palavra)
/*
10
...
const likes = 197
const mens = 'Sua foto recebeu ' + likes + ' likes'
