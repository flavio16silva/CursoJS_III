...
const obj = { a:7, b:3 }
//console.log(multiplicar(obj.a, obj.b))
...
//console.log(multiplicar(numeros[0], numeros[1]))
...
multiplicar(pegaNumerosImpares()[1], pegaNumerosImpares()[2])
//console.log(multiplicar(pegaNumerosImpares()[1], pegaNumerosImpares()[2]))
...
//console.log(pegaObj())
//console.log(multiplicar(pegaObj()[0].numero, pegaObj()[2].numero))
multiplicar(pegaObj()[0].numero, pegaObj()[2].numero)
...
const pegaPontuacao = (respostasUsuario) => {
  //['A', 'B', 'A' , 'D']
  const ultimaResposta = respostasUsuario[3] // D
  //let pontuacao = 0
  //const pontuacao = 0, abordagem mais direta para retornar somente os valores
  //Outra abordagem tirando os ELSE
  ...
  //return pontuacao
  //return só é valido dentro de função. 
